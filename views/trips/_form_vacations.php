...
<div class="row pt-1">
	...
	<div class="form-check">
		<?= Html::activeCheckbox($modelExpenses, "[{$index}]vacation", [
				'label' => false,
				'class' => 'form-check-input',
				'id' => 'ExpensesVacation' . $modelExpenses->id,
			]) ?>
		<label class="form-check-label" for="ExpensesVacation<?= $modelExpenses->id ?>">
